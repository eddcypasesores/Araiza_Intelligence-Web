"""Extractor de estados de cuenta Scotiabank."""
...
HEADER_TOKENS = ("FECHA", "DESCRIPCION", "DESCRIPCI?N")
FOOTER_PREFIXES = (
    "PAGINA",
    "P?GINA",
    "SCOTIABANK",
...
def extraer_scotiabank(pdf_file) -> pd.DataFrame:
