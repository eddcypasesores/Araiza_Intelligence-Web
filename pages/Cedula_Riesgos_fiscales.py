"""Riesgos Fiscales tool for the Cedula impuestos module."""
...
with upload_col:
    ...
    uploaded = st.file_uploader(
        ...
        help="Arrastra y suelta CFDI en XML (puedes subir varios a la vez).",
    )
...
<div class="risk-upload-wrapper">
  <div class="risk-dropzone" id="risk-dropzone">
    <div class="risk-dropzone-left">
      ...
      <div class="risk-text">
        <p class="risk-title">Arrastra y suelta tus CFDI (XML)</p>
        <p class="risk-subtitle">Puedes cargar varios archivos a la vez</p>
      </div>
    </div>
...
if not files:
    st.info("Carga uno o mas CFDI (XML) para analizar los riesgos fiscales.")
    st.stop()
